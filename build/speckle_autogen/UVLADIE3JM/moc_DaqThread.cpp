...
Q_CONSTINIT const QMetaObject DaqThread::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9DaqThreadE_t,
        ...
        // method 'daq_data_ready'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'daq_status_changed'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void DaqThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->daq_data_ready(); break;
        case 1: _t->daq_status_changed((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 2: _t->daq_message((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (DaqThread::*)();
            if (_q_method_type _q_method = &DaqThread::daq_data_ready; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (DaqThread::*)(int );
            if (_q_method_type _q_method = &DaqThread::daq_status_changed; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_q_method_type _q_method = &DaqThread::daq_message; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void DaqThread::daq_data_ready()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void DaqThread::daq_status_changed(int _t1)
{
...
// SIGNAL 2
void DaqThread::daq_message(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
